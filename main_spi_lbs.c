...
static void gpiote_init(void)
{
    ...
    err_code = nrf_drv_gpiote_in_init(MODULE_INT_PIN, &in_config, int_pin_handler);
    APP_ERROR_CHECK(err_code);

    nrf_drv_gpiote_in_event_enable(MODULE_INT_PIN, true);
}
...
/*static void buttons_init(void)
{
    ...
    static app_button_cfg_t buttons[] =
    {
        {LEDBUTTON_BUTTON_PIN, false, BUTTON_PULL, button_event_handler},
				{MODULE_INT_PIN, false, BUTTON_PULL, button_event_handler}
    };
